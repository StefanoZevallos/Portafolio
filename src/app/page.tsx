  ...
  return (
    <>
      <article className={styles.nav_container}>
        ...
        <p className='pl-[40px] font-bold'>STEFANO ZEVALLOS</p>
        <p className='font-bold'> DESARROLLADOR FULLSTACK</p>
        <p className='pl-[65px] font-bold'> Lima - Perú</p>
        <p className='pl-[65px] mt-[10px]'> CONTACTO</p>
        <p className='pl-[40px]'> +51 926-802-518</p>
      ...
      {/* <section className={styles.datos}>
        <p> Desarrollo Web</p>
        <p> Desarrollo Fronted</p>
        <p> Desarrollo Backend</p>
      </section> */}
      <p className='p-2 font-semibold ml-2'> PROYECTOS </p>

       {/* <div className={styles.scroll_container}>
      <section className={styles.proyectos_container}>
